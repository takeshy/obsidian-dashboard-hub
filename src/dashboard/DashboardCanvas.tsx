...
export function DashboardCanvas({
  ...
  const [activeLayoutDirection, setActiveLayoutDirection] = useState<EqualizeDirection>("horizontal");
  ...
  const handleLayoutDirection = useCallback((direction: EqualizeDirection) => {
    if (direction !== activeLayoutDirection) {
      setActiveLayoutDirection(direction);
      return;
    }
    handleEqualize(direction);
  }, [activeLayoutDirection, handleEqualize]);
  ...
  const handleAddWidget = useCallback(
    ...
    [activeLayoutDirection, data, commit],
  );
